...
export const Route = createFileRoute("/connect/instagram")({
  head: () => ({
    meta: [
      { title: "Connect Instagram — CowQ" },
      { name: "description", content: "Three quick steps to connect your Instagram to CowQ." },
    ...
    <main className="flex min-h-screen flex-col px-5 pb-24 pt-8">
      ...
      {step === 2 && (
        <div className="mt-8 flex flex-1 flex-col">
          ...
          <h2 className="mt-6 font-display text-[24px] leading-tight text-ink">Now link it to CowQ</h2>
          ...
          {notConfigured && (
            <div className="mt-4 rounded-[12px] bg-[#FDECEC] p-3 text-[13px] text-ink">
              Instagram connect isn't switched on yet on this app. Ask the CowQ team to finish setup — you'll be able to connect right after.
            </div>
          )}
          <WhyLink text="Why do you need this? So CowQ can publish posts on your behalf when you tap 'Post from CowQ'." />
        </div>
      )}
