    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          author: { "@type": "Organization", name: "CowQ" },
          publisher: {
            "@type": "Organization",
            name: "CowQ",
            logo: {
  ...
  return (
    <main className="flex min-h-screen flex-col gap-6 px-5 pb-16 pt-10">
      ...
      <p className="text-[15px] text-muted">
        ...
        shoot a flat lay product photo you can hand to CowQ for studio-quality
        marketplace images.
      </p>
      ...
      <Section title="From flat lay to marketplace-ready with CowQ">
        <p>
