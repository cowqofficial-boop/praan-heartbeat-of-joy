...
export const Route = createFileRoute("/connect")({
  ...
  head: () => ({
    meta: [
      { title: "Connect your channels — PRAAN" },
      { name: "description", content: "Connect Instagram, Facebook Page, and WhatsApp so PRAAN can post for you." },
      { property: "og:title", content: "Connect your channels — PRAAN" },
      { property: "og:description", content: "Link Instagram, Facebook Page, and WhatsApp to PRAAN." },
  ...
  return (
    <main className="flex min-h-screen flex-col px-5 pb-16 pt-8">
      ...
      <p className="mt-2 text-[15px] text-muted">
        Link the places you sell. PRAAN keeps working even if you skip this.
      </p>
...
function ChannelCard(props: {
  ...
  return (
    <section className="rounded-[12px] border border-[color:var(--color-border)] bg-white p-4">
      <div className="flex items-center gap-3">
        <div className="grid h-10 w-10 place-items-center rounded-full bg-[#FFF6EC] text-ink">
          {props.icon}
        </div>
