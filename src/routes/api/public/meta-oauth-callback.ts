...
function html(body: string, status = 200): Response {
  return new Response(
    `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>PRAAN — Instagram</title><style>
...
function ok(msg: string) {
  return html(`<h1>Connected ✓</h1><p>${msg}</p><a class="btn" href="/connect">Back to PRAAN</a><script>setTimeout(()=>{location.href="/connect"},1500)</script>`);
}
