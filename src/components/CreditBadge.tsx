...
export function CreditBadge() {
  ...
  return (
    <Link
      to="/pricing"
      className="flex h-9 items-center gap-1.5 rounded-full border border-[color:var(--color-border)] bg-raised pl-2.5 pr-3 text-[13px] font-semibold text-ink hover:bg-surface"
